...
func handleIncomingAdminConnection(conn net.Conn, g *gateway.Gateway) {
	...
	for {
		...
		if err == nil {
			if message.MessageType == fcrmessages.GatewayAdminGetReputationChallengeType {
				...
				continue
			} else if message.MessageType == fcrmessages.GatewayAdminSetReputationChallengeType {
				...
				continue
			} else if message.MessageType == fcrmessages.GatewayAdminAcceptKeyChallengeType {
